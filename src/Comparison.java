    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (twoValues.length == 2) {
                ...
                System.out.println("Ошибка: необходимо ввести ровно два числа!");
            }
